...
<body class="antialiased">
    <div
        ...
        @endif
        <div class="max-w-7xl mx-auto p-6 lg:p-8 bg-gray-500" style="bg">
            ...
            <div class="mt-16">
                ...
                <form action="{{ route('home') }}">
                    ip : <input type="text" name="ip" value="{{ request()->ip ?? '' }}"/>
                    
                    as json > 
                    <input type="checkbox" name="as_json" id="as_json"/>
                    <input type="submit" class="button " style="background: #4b5563"/>
                </form>
            </div>
