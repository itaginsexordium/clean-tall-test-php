...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function generate($serverKey, $format = 'yaml')
        {
                        /** @var \LaravelJsonApi\OpenApiSpec\OpenApiGenerator $instance */
                        return $instance->generate($serverKey, $format);
        }
...
namespace  { 
            ...
            class OpenApiGenerator extends \LaravelJsonApi\OpenApiSpec\Facades\GeneratorFacade {}
